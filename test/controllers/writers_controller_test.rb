...
class WritersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create writer" do
    assert_difference('Writer.count') do
      post writers_url, params: { writer: { experience: @writer.experience, expertise: @writer.expertise, name: @writer.name } }
    end
  ...
  test "should update writer" do
    patch writer_url(@writer), params: { writer: { experience: @writer.experience, expertise: @writer.expertise, name: @writer.name } }
